...
ssh root@101.133.133.127 "export gitee_token='%gitee_token%' && export gitee_gist_id='%gitee_gist_id%' && /opt/wireguard/wgc -l=7 syncgitee wgtun5 wgtest"
rem ssh -p 6443 root@8.210.19.98 "export gitee_token='%gitee_token%' && /opt/wireguard/wgc -l=7 syncgitee wgtest"
